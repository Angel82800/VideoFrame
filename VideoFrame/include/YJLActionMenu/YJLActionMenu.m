...
//    contentView.tag = noDisableVerticalScrollTag;
    ...
    {
        maxHeight = [UIScreen mainScreen].bounds.size.width > [UIScreen mainScreen].bounds.size.height ? [UIScreen mainScreen].bounds.size.height : [UIScreen mainScreen].bounds.size.width;
    }
    else
    {
        maxHeight = [UIScreen mainScreen].bounds.size.width > [UIScreen mainScreen].bounds.size.height ? [UIScreen mainScreen].bounds.size.width : [UIScreen mainScreen].bounds.size.height;
    }
    
    if (contentHeight > maxHeight)
    {
        contentView.frame = CGRectMake(0, 0, maxItemWidth, maxHeight - kMinMenuItemHeight*2/3);
