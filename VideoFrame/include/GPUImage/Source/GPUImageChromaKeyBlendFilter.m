...
(
 ...
 void main()
 {
     ...
     /********************************************************************************
      ITU-R BT.709 (RGB to YPbPr) HDTV conversion. by Yinjing Li at 2015/07/24

      R/G/B [0, 255]      Y [0, 255]      Pb/Pr [-127.5, 127.5]
      
      http://www.equasys.de/colorconversion.html
      ********************************************************************************/

     float maskY = 0.2126 * colorToReplace.r + 0.7152 * colorToReplace.g + 0.0722 * colorToReplace.b;
     float maskCb = 0.5389 * (colorToReplace.b - maskY);
     float maskCr = 0.6350 * (colorToReplace.r - maskY);
     
     float Y = 0.2126 * textureColor.r + 0.7152 * textureColor.g + 0.0722 * textureColor.b;
     float Cb = 0.5389 * (textureColor.b - Y);
     float Cr = 0.6350 * (textureColor.r - Y);
